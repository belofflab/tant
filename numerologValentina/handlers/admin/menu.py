...
""",
        ...
        {
            "name": "Отвязка от бывшего 😁",
            "type": 1,
            "description": """
После вступления в близкие 🔞🤭отношения мы создаём связь с партнёром которая не исчезает даже если вы уже расстались. Партнёр питается вашей энергией на протяжении всей своей жизни. Так природа создана, что мужчина не может без женской энергии ( он патухнет без неё) 
Даже если это была всего лишь одноразовая встреча, нужно делать отвязку!
Вы можете выполнять различные практики которые наполняют вас энергией или солнцезажигающие действия вы не получаете тот результат который могли, так как часть энергии моментально уходит к бывшим партнерам, и чем больше их было тем вы слабее.
Более того вы закрыты для пространства, для новых возможностей, работы, людей и достойных партнёров.
И ещё надо в конце каждого пункта написать 
