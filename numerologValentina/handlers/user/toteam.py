...
WORKER_NAME = "Виктоории"
WORKER_USERNAME = "viktoria_numer"


TEAM_DESCRIPTION = f"""
Если вы являетесь экспертом в сфере нумерологии/астрологии/таро и других подобных направлений, не знаете как себя продвигать, как на этом зарабатывать.
