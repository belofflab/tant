...
Revision ID: 951d0f1d333d
Revises: 
Create Date: 2024-03-23 17:20:31.633654
...
def upgrade() -> None:
    ...
    sa.Column('main_photo', sa.String(length=1024), nullable=False),
    sa.Column('main_description', sa.String(length=200), nullable=False),
    ...
    sa.ForeignKeyConstraint(['bot'], ['bots.id'], name='fk_taro_categories_bots_id_bot'),
    ...
    sa.ForeignKeyConstraint(['category'], ['taro_categories.id'], name='fk_taro_services_taro_categories_id_category'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('worker_users',
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.Column('worker', sa.BigInteger(), nullable=True),
    sa.Column('user', sa.BigInteger(), nullable=True),
    sa.ForeignKeyConstraint(['user'], ['users.id'], name='fk_worker_users_users_id_user'),
    sa.ForeignKeyConstraint(['worker'], ['workers.id'], name='fk_worker_users_workers_id_worker'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('worker', 'user', name='uc_worker_users_worker_user')
    )
