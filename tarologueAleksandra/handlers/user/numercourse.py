...
from data.config import ASKEZA, ALEKSANDRA
...
askeza_buttons = {
    "0": {
        "text": "О курсе",
        "description": """
Курс состоит из 8 подробных уроков в аудиоформате. Регулярные домашние задания для закрепления техник.
...
Полученные знания вы можете применять на себе, на своих близких. Также вы получите возможность вступить в команду и начать зарабатывать под моим сопровождением
""",
    },
    "1": {
        "text": "для кого курс",
...
- Исследуем зачем жить в энергии благости. 
    ...
    if isinstance(callback, types.CallbackQuery):
        await callback.message.edit_media(
            media=types.InputMediaPhoto(
                media=types.InputFile(ALEKSANDRA), caption=ASKEZA_DESCRIPTION
            ),
