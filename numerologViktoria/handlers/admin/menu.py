...
""",
        ...
        {
            "name": "9️⃣ Энергетическая отвязка",
            "type": 1,
            "description": """
...
""",
        ...
        {
            "name": "🔟 Денежная нейроформула",
            "type": 1,
            "description": """
Ваша нейроформула - это ключ к финансовому успеху! Она не зависит от лунных фаз, но в дни, когда вы чувствуете себя особенно сильными или в важные астрологические даты она работает как волшебство 🧚🏻‍♀️

Просто представьте:
Ваша уникальная числовая матрица синхронизируется с потоком богатства.

Ваша энергия настроена на привлечение денег, словно магнит притягивает финансы.

Стабильный поток доходов начинает течь в вашу жизнь, принося финансовое изобилие.


Новые возможности для заработка открываются одна за другой, как двери в комнату сокровищ.

И самое удивительное - первый доход приходит сразу после активации формулы, как будто вы нашли клад!


Активируйте свою нейроформулу и позвольте финансовому потоку войти в вашу жизнь!
