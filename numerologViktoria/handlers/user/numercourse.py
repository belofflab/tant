...
askeza_buttons = {
    "0": {
        "text": "О курсе",
        "description": """
Курс состоит из 10 подробных уроков в аудиоформате. 

Регулярные домашние задания для закрепления техник.
Также вы получаете доступ к бонусной информации и «Расчет личного финансового кода».
Всё материалы будут доступны вам в течение 6 месяцев.

Полученные знания вы можете применять на себе, на своих близких.

Самое главное, вы научитесь делать прогнозы по событиям это самая востребованная услуга на данный момент.
""",
    },
    "1": {
        "text": "для кого курс",
